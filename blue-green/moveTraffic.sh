...
# kubectl get virtualservice deploy-test-blue-green-vs -o yaml | python -c 'import sys,yaml; yml = yaml.safe_load(sys.stdin); print(yaml.dump(yml["spec"]["http"][0]["route"]));'